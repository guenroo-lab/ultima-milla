create or replace function staging.registrar_ya_cargados_masivo(p_numeros_pedido text[], p_tienda text default null)
...
begin
  ...
  perform pg_advisory_xact_lock(hashtext('staging.registrar_ya_cargados_masivo'));
...
grant execute on function staging.registrar_ya_cargados_masivo(text[], text) to service_role;
